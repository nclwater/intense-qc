...
This returns a :py:meth:`Gauge <intense.gauge.Gauge>` object.

If your file is not in INTENSE format, you will need to manually create the :py:meth:`Gauge <intense.gauge.Gauge>` object:
...
To run quality control, create a :py:meth:`Qc <intense.qc.Qc>` object using a :py:meth:`Gauge <intense.gauge.Gauge>` and call
